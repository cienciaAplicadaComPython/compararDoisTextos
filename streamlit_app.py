...
if botaoFoiSelecionado:
  ...
  #Caso duas entradas sejam enviadas 
    ...
    st.download_button('Baixe as palavras diferentes em CSV', data = dataFrameDePalavrasDiferentes.to_csv().encode('utf-8'), file_name = 'palavrasDiferentes.csv', mime = 'text/csv')
    #---------------------------------------------------------------------
  #---------------------------------------------------------------------
